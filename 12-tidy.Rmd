...
```{r tidy-gather, echo = FALSE, out.width = "100%", fig.cap = "Reuniendo `tabla4` en un formato ordenado."}
...
```{r tidy-spread, echo = FALSE, out.width = "100%", fig.cap = "Extender la `tabla2` la vuelve ordenada"}
